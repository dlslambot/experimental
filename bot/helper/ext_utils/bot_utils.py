...
from bot import download_dict, download_dict_lock, OWNER_ID, STATUS_LIMIT, LOGGER, botStartTime, DOWNLOAD_DIR, status_reply_dict_lock, status_reply_dict, dispatcher
